...
Tu peux créer ta propre méthode de conversion. C'est souvent plus flexible et adapté à tes besoins.  
Par exemple, tuaAjouts une méthode `static` `fromString()` dans ton enum :
...
Bref, en un mot comme en cent : **utilise-les !**
